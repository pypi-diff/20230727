# Comparing `tmp/django-webstack-1.3.6.3.tar.gz` & `tmp/django-webstack-1.4.0.tar.gz`
...
### Comparing `django-webstack-1.3.6.3/setup.py` & `django-webstack-1.4.0/setup.py`
