# Comparing `tmp/django-webstack-1.3.6.tar.gz` & `tmp/django-webstack-1.3.6.1.tar.gz`
...
### Comparing `django-webstack-1.3.6/setup.py` & `django-webstack-1.3.6.1/setup.py`
