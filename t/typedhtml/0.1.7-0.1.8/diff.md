# Comparing `tmp/typedhtml-0.1.7.tar.gz` & `tmp/typedhtml-0.1.8.tar.gz`
...
### Comparing `typedhtml-0.1.7/typedhtml/ui5/segmented_button.py` & `typedhtml-0.1.8/typedhtml/ui5/segmented_button.py`
