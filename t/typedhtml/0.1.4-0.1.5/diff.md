# Comparing `tmp/typedhtml-0.1.4.tar.gz` & `tmp/typedhtml-0.1.5.tar.gz`
...
### Comparing `typedhtml-0.1.4/typedhtml/ui5/message_strip.py` & `typedhtml-0.1.5/typedhtml/ui5/message_strip.py`
