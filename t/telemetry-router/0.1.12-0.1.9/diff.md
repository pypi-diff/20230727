# Comparing `tmp/telemetry_router-0.1.12.tar.gz` & `tmp/telemetry_router-0.1.9.tar.gz`

## Comparing `telemetry_router-0.1.12.tar` & `telemetry_router-0.1.9.tar`

### file list

```diff
@@ -1,33 +1,32 @@
--rw-r--r--   0        0        0      393 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/.copier-answers.yml
--rw-r--r--   0        0        0       84 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/.prettierignore
--rw-r--r--   0        0        0       57 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/.yarnrc.yml
--rw-r--r--   0        0        0       86 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/CHANGELOG.md
--rw-r--r--   0        0        0     3925 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/RELEASE.md
--rw-r--r--   0        0        0      193 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/install.json
--rw-r--r--   0        0        0     6473 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/package.json
--rw-r--r--   0        0        0       33 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/setup.py
--rw-r--r--   0        0        0      554 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/tsconfig.json
--rw-r--r--   0        0        0   221121 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/yarn.lock
--rw-r--r--   0        0        0       93 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/jupyter-config/nb-config/telemetry_router.json
--rw-r--r--   0        0        0       91 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/jupyter-config/server-config/telemetry_router.json
--rw-r--r--   0        0        0      756 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/src/consumer.ts
--rw-r--r--   0        0        0     1110 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/src/handler.ts
--rw-r--r--   0        0        0     2446 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/src/index.ts
--rw-r--r--   0        0        0      138 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/style/base.css
--rw-r--r--   0        0        0       25 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/style/index.css
--rw-r--r--   0        0        0       21 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/style/index.js
--rw-r--r--   0        0        0      850 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/telemetry_router/__init__.py
--rw-r--r--   0        0        0      172 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/telemetry_router/_version.py
--rw-r--r--   0        0        0     1241 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/telemetry_router/application.py
--rw-r--r--   0        0        0     2741 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/telemetry_router/handlers.py
--rw-r--r--   0        0        0     5695 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/telemetry_router/labextension/package.json
--rw-r--r--   0        0        0     2082 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/telemetry_router/labextension/static/0.832fda211b4e8a968724.js
--rw-r--r--   0        0        0     4012 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/telemetry_router/labextension/static/747.3ba83e0acd2b381f34b2.js
--rw-r--r--   0        0        0     6481 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/telemetry_router/labextension/static/remoteEntry.df3ed054973d9dfef99a.js
--rw-r--r--   0        0        0      159 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/telemetry_router/labextension/static/style.js
--rw-r--r--   0        0        0     2452 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/telemetry_router/labextension/static/third-party-licenses.json
--rw-r--r--   0        0        0     1577 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/.gitignore
--rw-r--r--   0        0        0     1516 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/LICENSE
--rw-r--r--   0        0        0     3029 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/README.md
--rw-r--r--   0        0        0     2471 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/pyproject.toml
--rw-r--r--   0        0        0     5947 2020-02-02 00:00:00.000000 telemetry_router-0.1.12/PKG-INFO
...
### Comparing `telemetry_router-0.1.12/RELEASE.md` & `telemetry_router-0.1.9/RELEASE.md`

 * *Files identical despite different names*

### Comparing `telemetry_router-0.1.12/package.json` & `telemetry_router-0.1.9/telemetry_router/labextension/package.json`
...
### Comparing `telemetry_router-0.1.12/tsconfig.json` & `telemetry_router-0.1.9/tsconfig.json`

 * *Files identical despite different names*

### Comparing `telemetry_router-0.1.12/yarn.lock` & `telemetry_router-0.1.9/yarn.lock`
...
### Comparing `telemetry_router-0.1.12/src/handler.ts` & `telemetry_router-0.1.9/src/handler.ts`

 * *Files identical despite different names*

### Comparing `telemetry_router-0.1.12/src/index.ts` & `telemetry_router-0.1.9/src/index.ts`
...
-    const version = await requestAPI<any>('version');
...
-
-    // Register consumers on the router
-    new ConsoleLogger();
-    new MongoDBLogger();
-
...
### Comparing `telemetry_router-0.1.12/telemetry_router/__init__.py` & `telemetry_router-0.1.9/telemetry_router/__init__.py`

 * *Files identical despite different names*

### Comparing `telemetry_router-0.1.12/telemetry_router/application.py` & `telemetry_router-0.1.9/telemetry_router/application.py`
...
### Comparing `telemetry_router-0.1.12/telemetry_router/handlers.py` & `telemetry_router-0.1.9/telemetry_router/handlers.py`
...
### Comparing `telemetry_router-0.1.12/telemetry_router/labextension/package.json` & `telemetry_router-0.1.9/package.json`
...
-        "_build": {
-            "extension": "./extension",
-            "load": "static/remoteEntry.df3ed054973d9dfef99a.js",
-            "style": "./style"
-        },
         "discovery": {
             "server": {
...
### Comparing `telemetry_router-0.1.12/telemetry_router/labextension/static/0.832fda211b4e8a968724.js` & `telemetry_router-0.1.9/telemetry_router/labextension/static/763.7fc2a1794f2943f4acb5.js`
...
-            }
-        }
-        const u = "telemetry-router:plugin",
-            d = new t.Token(u);
-        class h {
-            constructor() {
-                this.sequence = 0
...
-                        notebookContent: null === (l = null === (c = this.notebookPanel) || void 0 === c ? void 0 : c.model) || void 0 === l ? void 0 : l.toJSON()
-                    }
-                };
...
### Comparing `telemetry_router-0.1.12/telemetry_router/labextension/static/747.3ba83e0acd2b381f34b2.js` & `telemetry_router-0.1.9/telemetry_router/labextension/static/747.3ba83e0acd2b381f34b2.js`

 * *Files identical despite different names*

### Comparing `telemetry_router-0.1.12/telemetry_router/labextension/static/remoteEntry.df3ed054973d9dfef99a.js` & `telemetry_router-0.1.9/telemetry_router/labextension/static/remoteEntry.07a29c704af1bfd3164a.js`
...
@@ -1,31 +1,31 @@
 ...
 (() => {
     "use strict";
-    var e, r, t, n, o, i, a, u, l, f, s, d, p, c, h, v, m = {
...
-    }(), g.o = (e, r) => Object.prototype.hasOwnProperty.call(e, r), e = {}, r = "telemetry-router:", g.l = (t, n, o, i) => {
...
-            a || (u = !0, (a = document.createElement("script")).charset = "utf-8", a.timeout = 120, g.nc && a.setAttribute("nonce", g.nc), a.setAttribute("data-webpack", r + o), a.src = t), e[t] = [n];
...
-                })("telemetry-router", "0.1.12"), e[t] = u.length ? Promise.all(u).then((() => e[t] = 1)) : 1
...
+    }, l = (e, r, t, n) => "Unsatisfied version " + t + " from " + (t && e[r][t].from) + " of shared singleton module " + r + " (required " + o(n) + ")", s = (e, r, t, n) => {
         var o = u(e, t);
-        return i(n, o) || s(l(e, t, o, n)), d(e[t][o])
-    }, s = e => {
...
-        var i = g.I(r);
-        return i && i.then ? i.then(e.bind(e, r, g.S[r], t, n, o)) : e(r, g.S[r], t, n)
-    })(((e, r, t, n) => (a(e, t), f(r, 0, t, n)))), c = {}, h = {
-        790: () => p("default", "@jupyterlab/services", [1, 7, 0, 3]),
-        930: () => p("default", "@lumino/coreutils", [1, 2, 0, 0]),
-        987: () => p("default", "@jupyterlab/coreutils", [1, 6, 0, 3])
...
+                var n, o, [a, i, u] = t,
                     l = 0;
-                if (i.some((r => 0 !== e[r]))) {
-                    for (n in a) g.o(a, n) && (g.m[n] = a[n]);
+                if (a.some((r => 0 !== e[r]))) {
+                    for (n in i) g.o(i, n) && (g.m[n] = i[n]);
                     u && u(g)
                 }
-                for (r && r(t); l < i.length; l++) o = i[l], g.o(e, o) && e[o] && e[o][0](), e[o] = 0
...
### Comparing `telemetry_router-0.1.12/telemetry_router/labextension/static/third-party-licenses.json` & `telemetry_router-0.1.9/telemetry_router/labextension/static/third-party-licenses.json`

 * *Files identical despite different names*

### Comparing `telemetry_router-0.1.12/.gitignore` & `telemetry_router-0.1.9/.gitignore`

 * *Files identical despite different names*

### Comparing `telemetry_router-0.1.12/LICENSE` & `telemetry_router-0.1.9/LICENSE`

 * *Files identical despite different names*

### Comparing `telemetry_router-0.1.12/README.md` & `telemetry_router-0.1.9/README.md`

 * *Files identical despite different names*

### Comparing `telemetry_router-0.1.12/pyproject.toml` & `telemetry_router-0.1.9/pyproject.toml`

 * *Files identical despite different names*

### Comparing `telemetry_router-0.1.12/PKG-INFO` & `telemetry_router-0.1.9/PKG-INFO`
