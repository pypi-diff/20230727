# Comparing `tmp/mypy-boto3-support-app-1.28.0.tar.gz` & `tmp/mypy-boto3-support-app-1.28.12.tar.gz`
...
### Comparing `mypy-boto3-support-app-1.28.0/LICENSE` & `mypy-boto3-support-app-1.28.12/LICENSE`
