# Comparing `tmp/multilectic-0.0.4.tar.gz` & `tmp/multilectic-0.0.5.tar.gz`
...
## Comparing `multilectic-0.0.4.tar` & `multilectic-0.0.5.tar`
...
### Comparing `multilectic-0.0.4/LICENSE` & `multilectic-0.0.5/LICENSE`

 * *Files identical despite different names*

### Comparing `multilectic-0.0.4/PKG-INFO` & `multilectic-0.0.5/PKG-INFO`
...
### Comparing `multilectic-0.0.4/pyproject.toml` & `multilectic-0.0.5/pyproject.toml`
...
### Comparing `multilectic-0.0.4/src/multilectic/positions.py` & `multilectic-0.0.5/src/multilectic/positions.py`
...
### Comparing `multilectic-0.0.4/src/multilectic.egg-info/PKG-INFO` & `multilectic-0.0.5/src/multilectic.egg-info/PKG-INFO`
