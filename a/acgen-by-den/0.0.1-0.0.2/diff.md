# Comparing `tmp/acgen_by_den-0.0.1.tar.gz` & `tmp/acgen_by_den-0.0.2.tar.gz`
...
### Comparing `acgen_by_den-0.0.1/acgen_by_den/locale_handler.py` & `acgen_by_den-0.0.2/acgen_by_den/locale_handler.py`
