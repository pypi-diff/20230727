# Comparing `tmp/amazon_products_scraper-0.0.2.tar.gz` & `tmp/amazon_products_scraper-0.0.3.tar.gz`
...
## Comparing `amazon_products_scraper-0.0.2.tar` & `amazon_products_scraper-0.0.3.tar`
...
### Comparing `amazon_products_scraper-0.0.2/PKG-INFO` & `amazon_products_scraper-0.0.3/PKG-INFO`
...
### Comparing `amazon_products_scraper-0.0.2/README.md` & `amazon_products_scraper-0.0.3/README.md`

 * *Files identical despite different names*

### Comparing `amazon_products_scraper-0.0.2/amazon_products_scraper.egg-info/PKG-INFO` & `amazon_products_scraper-0.0.3/amazon_products_scraper.egg-info/PKG-INFO`
...
### Comparing `amazon_products_scraper-0.0.2/amazon_scraper/scraper.py` & `amazon_products_scraper-0.0.3/amazon_scraper/scraper.py`

 * *Files identical despite different names*

### Comparing `amazon_products_scraper-0.0.2/setup.py` & `amazon_products_scraper-0.0.3/setup.py`
