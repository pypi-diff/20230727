# Comparing `tmp/amazon_scrape-0.0.1.tar.gz` & `tmp/amazon_scrape-0.0.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dist/amazon_scrape-0.0.1.tar", last modified: Thu Jul 27 09:43:06 2023, max compression
+gzip compressed data, was "dist/amazon_scrape-0.0.2.tar", last modified: Thu Jul 27 09:45:29 2023, max compression
```

## Comparing `amazon_scrape-0.0.1.tar` & `amazon_scrape-0.0.2.tar`

### file list

```diff
@@ -1,17 +1,17 @@
-drwxr-xr-x   0 finn       (501) staff       (20)        0 2023-07-27 09:43:06.146104 amazon_scrape-0.0.1/
--rw-r--r--   0 finn       (501) staff       (20)     4220 2023-07-27 09:43:06.148641 amazon_scrape-0.0.1/PKG-INFO
--rw-r--r--   0 finn       (501) staff       (20)     1599 2023-07-27 09:15:43.000000 amazon_scrape-0.0.1/README.md
-drwxr-xr-x   0 finn       (501) staff       (20)        0 2023-07-27 09:43:06.129354 amazon_scrape-0.0.1/amazon_scrape.egg-info/
--rw-r--r--   0 finn       (501) staff       (20)     4220 2023-07-27 09:43:05.000000 amazon_scrape-0.0.1/amazon_scrape.egg-info/PKG-INFO
--rw-r--r--   0 finn       (501) staff       (20)      367 2023-07-27 09:43:05.000000 amazon_scrape-0.0.1/amazon_scrape.egg-info/SOURCES.txt
--rw-r--r--   0 finn       (501) staff       (20)        1 2023-07-27 09:43:05.000000 amazon_scrape-0.0.1/amazon_scrape.egg-info/dependency_links.txt
--rw-r--r--   0 finn       (501) staff       (20)       70 2023-07-27 09:43:05.000000 amazon_scrape-0.0.1/amazon_scrape.egg-info/entry_points.txt
--rw-r--r--   0 finn       (501) staff       (20)        1 2023-07-27 09:43:05.000000 amazon_scrape-0.0.1/amazon_scrape.egg-info/not-zip-safe
--rw-r--r--   0 finn       (501) staff       (20)       24 2023-07-27 09:43:05.000000 amazon_scrape-0.0.1/amazon_scrape.egg-info/requires.txt
--rw-r--r--   0 finn       (501) staff       (20)       15 2023-07-27 09:43:05.000000 amazon_scrape-0.0.1/amazon_scrape.egg-info/top_level.txt
-drwxr-xr-x   0 finn       (501) staff       (20)        0 2023-07-27 09:43:06.142338 amazon_scrape-0.0.1/amazon_scraper/
--rw-r--r--   0 finn       (501) staff       (20)       48 2023-07-27 09:15:43.000000 amazon_scrape-0.0.1/amazon_scraper/__init__.py
--rw-r--r--   0 finn       (501) staff       (20)     5856 2023-07-27 09:15:43.000000 amazon_scrape-0.0.1/amazon_scraper/scraper.py
--rw-r--r--   0 finn       (501) staff       (20)       17 2023-07-27 09:38:23.000000 amazon_scrape-0.0.1/amazon_scraper/version.py
--rw-r--r--   0 finn       (501) staff       (20)       38 2023-07-27 09:43:06.150072 amazon_scrape-0.0.1/setup.cfg
--rw-r--r--   0 finn       (501) staff       (20)     2732 2023-07-27 09:43:03.000000 amazon_scrape-0.0.1/setup.py
...
### Comparing `amazon_scrape-0.0.1/PKG-INFO` & `amazon_scrape-0.0.2/PKG-INFO`
...
### Comparing `amazon_scrape-0.0.1/README.md` & `amazon_scrape-0.0.2/README.md`

 * *Files identical despite different names*

### Comparing `amazon_scrape-0.0.1/amazon_scrape.egg-info/PKG-INFO` & `amazon_scrape-0.0.2/amazon_scrape.egg-info/PKG-INFO`
...
### Comparing `amazon_scrape-0.0.1/amazon_scraper/scraper.py` & `amazon_scrape-0.0.2/amazon_scraper/scraper.py`

 * *Files identical despite different names*

### Comparing `amazon_scrape-0.0.1/setup.py` & `amazon_scrape-0.0.2/setup.py`
