# Comparing `tmp/biliarchiver-0.0.33.tar.gz` & `tmp/biliarchiver-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "biliarchiver-0.0.33.tar", max compression
+gzip compressed data, was "biliarchiver-0.0.9.tar", max compression
```

## Comparing `biliarchiver-0.0.33.tar` & `biliarchiver-0.0.9.tar`

### file list

```diff
@@ -1,21 +1,13 @@
--rw-r--r--   0        0        0      131 2023-07-07 09:38:51.631616 biliarchiver-0.0.33/README.md
--rw-r--r--   0        0        0    10367 2023-07-26 18:53:44.288189 biliarchiver-0.0.33/biliarchiver/_biliarchiver_upload_bvid.py
--rw-r--r--   0        0        0    12533 2023-07-27 08:48:12.666728 biliarchiver-0.0.33/biliarchiver/archive_bvid.py
--rw-r--r--   0        0        0     9054 2023-07-26 18:37:15.451449 biliarchiver-0.0.33/biliarchiver/cli_tools/bili_archive_bvids.py
--rw-r--r--   0        0        0     8092 2023-07-21 19:21:33.570874 biliarchiver-0.0.33/biliarchiver/cli_tools/bili_get_bvids.py
--rw-r--r--   0        0        0     2522 2023-07-23 08:20:04.085341 biliarchiver-0.0.33/biliarchiver/cli_tools/bili_upload.py
--rw-r--r--   0        0        0      413 2023-07-07 09:38:51.635616 biliarchiver-0.0.33/biliarchiver/cli_tools/biliarchiver.py
--rw-r--r--   0        0        0     2221 2023-07-20 09:58:51.188806 biliarchiver-0.0.33/biliarchiver/config.py
--rw-r--r--   0        0        0      375 2023-07-20 10:58:49.404609 biliarchiver-0.0.33/biliarchiver/exception.py
--rw-r--r--   0        0        0     1920 2023-07-20 15:27:30.175094 biliarchiver-0.0.33/biliarchiver/utils/black_list.py
--rw-r--r--   0        0        0     3105 2023-07-25 15:40:12.904947 biliarchiver-0.0.33/biliarchiver/utils/dirLock.py
--rw-r--r--   0        0        0      237 2023-07-07 09:38:51.635616 biliarchiver-0.0.33/biliarchiver/utils/ffmpeg.py
--rw-r--r--   0        0        0     1085 2023-07-18 04:24:04.652661 biliarchiver-0.0.33/biliarchiver/utils/http_patch.py
--rw-r--r--   0        0        0     1278 2023-07-07 09:38:51.635616 biliarchiver-0.0.33/biliarchiver/utils/identifier.py
--rw-r--r--   0        0        0      690 2023-07-24 14:21:52.343746 biliarchiver-0.0.33/biliarchiver/utils/storage.py
--rw-r--r--   0        0        0     1606 2023-07-25 18:36:58.299641 biliarchiver-0.0.33/biliarchiver/utils/version_check.py
--rw-r--r--   0        0        0     2745 2023-07-25 18:20:28.861939 biliarchiver-0.0.33/biliarchiver/utils/xml_chars.py
--rw-r--r--   0        0        0       32 2023-07-27 08:49:47.699568 biliarchiver-0.0.33/biliarchiver/version.py
--rw-r--r--   0        0        0      665 2023-07-27 08:49:37.055474 biliarchiver-0.0.33/pyproject.toml
--rw-r--r--   0        0        0     1307 1970-01-01 00:00:00.000000 biliarchiver-0.0.33/setup.py
--rw-r--r--   0        0        0      686 1970-01-01 00:00:00.000000 biliarchiver-0.0.33/PKG-INFO
...
### Comparing `biliarchiver-0.0.33/biliarchiver/_biliarchiver_upload_bvid.py` & `biliarchiver-0.0.9/biliarchiver/_biliarchiver_upload_bvid.py`
...
### Comparing `biliarchiver-0.0.33/biliarchiver/config.py` & `biliarchiver-0.0.9/biliarchiver/config.py`
...
### Comparing `biliarchiver-0.0.33/biliarchiver/utils/dirLock.py` & `biliarchiver-0.0.9/biliarchiver/utils/dirLock.py`
...
### Comparing `biliarchiver-0.0.33/biliarchiver/utils/identifier.py` & `biliarchiver-0.0.9/biliarchiver/utils/string.py`
