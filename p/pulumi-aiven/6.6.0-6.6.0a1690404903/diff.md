# Comparing `tmp/pulumi_aiven-6.6.0.tar.gz` & `tmp/pulumi_aiven-6.6.0a1690404903.tar.gz`
...
### Comparing `pulumi_aiven-6.6.0/pulumi_aiven/open_search.py` & `pulumi_aiven-6.6.0a1690404903/pulumi_aiven/open_search.py`
