# Comparing `tmp/ccsf-1.0.1.tar.gz` & `tmp/ccsf-1.0.2.tar.gz`
...
## Comparing `ccsf-1.0.1.tar` & `ccsf-1.0.2.tar`
...
### Comparing `ccsf-1.0.1/LICENSE` & `ccsf-1.0.2/LICENSE`

 * *Files identical despite different names*

### Comparing `ccsf-1.0.1/PKG-INFO` & `ccsf-1.0.2/PKG-INFO`
...
### Comparing `ccsf-1.0.1/README.md` & `ccsf-1.0.2/README.md`

 * *Files identical despite different names*

### Comparing `ccsf-1.0.1/ccsf/ccsf.py` & `ccsf-1.0.2/ccsf/ccsf.py`

 * *Files identical despite different names*

### Comparing `ccsf-1.0.1/ccsf/class_discriminative_opt/class_discriminative_opt.py` & `ccsf-1.0.2/ccsf/class_discriminative_opt/class_discriminative_opt.py`

 * *Files identical despite different names*

### Comparing `ccsf-1.0.1/ccsf/group_centroid_opt/group_centroid_opt.py` & `ccsf-1.0.2/ccsf/group_centroid_opt/group_centroid_opt.py`

 * *Files identical despite different names*

### Comparing `ccsf-1.0.1/ccsf.egg-info/PKG-INFO` & `ccsf-1.0.2/ccsf.egg-info/PKG-INFO`
...
### Comparing `ccsf-1.0.1/setup.py` & `ccsf-1.0.2/setup.py`
