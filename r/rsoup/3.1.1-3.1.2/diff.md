# Comparing `tmp/rsoup-3.1.1.tar.gz` & `tmp/rsoup-3.1.2.tar.gz`
...
### Comparing `rsoup-3.1.1/tests/extractors/test_table_extractor.rs` & `rsoup-3.1.2/tests/extractors/test_table_extractor.rs`
