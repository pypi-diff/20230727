# Comparing `tmp/Furious-GUI-0.1.5.tar.gz` & `tmp/Furious-GUI-0.1.6.tar.gz`
...
### Comparing `Furious-GUI-0.1.5/Furious/Core/Configuration.py` & `Furious-GUI-0.1.6/Furious/Core/Configuration.py`
